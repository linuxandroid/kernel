...
KERNEL_CROSS_COMPILE=~/Toolchain/prebuilts/gcc/linux-x86/arm/arm-eabi-4.7/bin/arm-eabi-
KERNEL_OUT := ~/android/kernel/
TARGET_PREBUILT_INT_KERNEL = ~/android/kernel/arch/arm/boot/zImage
...
$(KBUILD_TARGET): $(TARGET_PREBUILT_INT_KERNEL)
	...
	cp -f $(local_path)/mhi.ko $(KBUILD_MODULE)
